...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/directives/login-form/login-form.html',
    ...
    '    <input style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-position: right center; cursor: auto;" class="form-control input-lg ng-pristine ng-untouched ng-invalid ng-invalid-required" name="email" ng-model="user.email" placeholder="Email" required="" autofocus="" type="text">\n' +
    '    <span class="ion-at form-control-feedback"></span>\n' +
    '  </div>\n' +
    '  <div class="form-group has-feedback">\n' +
    '    <input style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-position: right center; cursor: auto;" class="form-control input-lg ng-pristine ng-untouched ng-invalid ng-invalid-required" name="password" ng-model="user.password" placeholder="Password" required="" type="password">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/directives/login-form.old/login-form.html',
    '<form class="ng-pristine ng-invalid ng-invalid-required" method="post" ng-submit="vm.login()" name="loginForm">\n' +
    '  <div class="form-group has-feedback">\n' +
    '    <input style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-position: right center; cursor: auto;" class="form-control input-lg ng-pristine ng-untouched ng-invalid ng-invalid-required" name="email" ng-model="user.email" placeholder="Email" required="" autofocus="" type="text">\n' +
    '    <span class="ion-at form-control-feedback"></span>\n' +
